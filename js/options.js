...
var suo = {
  ...
  adInline: () => {
    const inlineAd = suo.cons.donateData?.ad[0]?.find(
      (ad) => ad.type === "ad-inline" && !ad.on,
    );
  ...
  welcome: () => {
    const oninstallAd =
      ...
      suo.cons.donateData?.ad[0]?.find(
        (ad) => ad.type === "ad-oninstall_popin" && !ad.on,
      );
  ...
  handleEvent: function (e) {
    ...
    switch (e.type) {
      ...
      case "mousedown":
        if (
          e.button == 0 &&
          (e.target.classList.contains("box_head") ||
            e.target.classList.contains("box_title"))
        ) {
      ...
      case "click":
        ...
        switch (ele.id) {
          ...
          case "chk_general_settings_autosave":
            if (e.target.checked) {
              ...
              document.querySelector(".nav_btn_save").style.display =
                "inline-block";
            }
          ...
          case "nav_reset":
            ...
            config[suo.cons.currentOBJArray[0]][suo.cons.currentOBJArray[1]] =
              defaultConf[suo.cons.currentOBJArray[0]][
                suo.cons.currentOBJArray[1]
              ];
            suo.saveConf2();
            window.setTimeout(function () {
              window.location.reload();
        ...
        if (
          ele.classList.contains("box_tabtitle") &&
          !ele.classList.contains("box_tabtitleactive")
        ) {
          suo.tabSwitch(e);
        }
        ...
        if (
          ele.classList.contains("menu_hide") &&
          !ele.classList.contains("cancel_hide")
        ) {
        ...
        if (ele.classList.contains("box_btn_next")) {
          ...
          if (ckdir) {
            suo.itemEdit(
              ...
              "add",
              ckdir[2],
              suo.getDataset(ele, "actiontype", "value"),
            );
            suo.boxClose2(e);
          }
        }
        ...
        if (
          ele.classList.contains("box_btn_close") ||
          e.target.classList.contains("box_btn_cancel")
        ) {
        ...
        if (
          ...
          (ele.tagName.toLowerCase() != "html" &&
            ele.parentNode.classList.contains("rate"))
        ) {
          chrome.tabs.create({ url: suo.cons.webstoreURL });
        }
        if (
          ele.classList.contains("donate") ||
          (ele.tagName.toLowerCase() != "html" &&
            ele.parentNode.classList.contains("donate"))
        ) {
          suo.donateBox.showDonate();
        }
        ...
        if (
          ele.classList.contains("menup") &&
          !e.target.classList.contains("menu-current")
        ) {
          suo.clickMenuDiv(e);
        }
        if (ele.classList.contains("item_edit")) {
          ...
          if (
            ...
            e.target.dataset.actiontype == "ksa"
          ) {
            suo.itemEditKsa(e);
          } else {
            suo.itemEditBefor(e);
      ...
      case "change":
        ...
        if (e.target.classList.contains("box_check")) {
          if (e.target.nextSibling && e.target.nextSibling.nextSibling) {
            if (e.target.checked) {
              e.target.nextSibling.nextSibling.style.cssText +=
                "display:block;";
            } else {
        ...
        if (e.target.classList.contains("box_radiooption")) {
          var _domRadioList =
            e.target.parentNode.parentNode.querySelectorAll(".box_radiolist");
          for (var i = 0; i < _domRadioList.length; i++) {
            _domRadioList[i].style.cssText += "display:none;";
          }
          if (
            e.target.checked &&
            e.target.parentNode.querySelector(".box_radiolist")
          ) {
            e.target.parentNode.querySelector(".box_radiolist").style.cssText +=
              "display:block;";
          }
        }
        ...
        if (
          e.target.classList.contains("box_select") &&
          e.target.name == "n_mail"
        ) {
        ...
        if (
          e.target.classList.contains("box_select") &&
          e.target.value == "add_from_select"
        ) {
          suo.boxClose2(e);
          var confobj =
          ...
          suo.itemEdit(
            ...
            e.target.name.substr(
              2,
            ) /*(e.target.name.indexOf("engine")!=-1?"engine":"script")*/,
          );
        }
        ...
        if (e.target.classList.contains("change-checkbox")) {
          ...
          if (e.target.dataset.confele == "autosave") {
            ...
            e.target.checked
              ? (document.querySelector("#menuplus_save").style.display =
                  "none")
              : (document.querySelector("#menuplus_save").style.display =
                  "block");
          }
        ...
        if (e.target.id == "mydes") {
          if (e.target.checked) {
            document.querySelector(
              ".box-content #mydesbox #mydestext",
        ...
        if (e.target.classList.contains("box_desck")) {
          var getele = function (ele) {
            if (
              ele.tagName.toLowerCase() == "smartup" &&
              ele.classList.contains("su_apps")
            ) {
              return ele;
            } else {
  ...
  initExclusion: () => {
    ...
    if (config.general.exclusion.exclusiontype == "black") {
      document.querySelector("#exclusion_black").style.cssText +=
        "display:block;";
      document.querySelector("#exclusion_white").style.cssText +=
        "display:none;";
    } else {
      document.querySelector("#exclusion_white").style.cssText +=
        "display:block;";
  ...
  showList: function (e) {
    var btnArray = [];
    var _dom = suo.initAPPbox(
      btnArray,
      [400, 230],
      suo.getI18n("tip_showlist"),
      "bg",
      "showlist",
    );
    ...
    var _ul = suo.domCreate2(
      ...
      "height:" +
        ...
        "px;list-style:none;padding:0;margin:0;min-width:300px;",
    );
      ...
      for (var j = 0; j < confOBJ[i].direct.length; j++) {
        var _img = suo.domCreate2(
          "img",
          {
            ...
            setValue: [
              "item_edit",
              chrome.extension.getURL("") + "image/" + "direct.png",
            ],
          },
          null,
    ...
    _dom.querySelector(".box_content").style.cssText +=
  ...
  initI18n: function () {
    ...
    for (var i = 0; i < i18nOBJ.length; i++) {
      ...
      if (
        i18nOBJ[i].tagName.toLowerCase() == "input" &&
        i18nOBJ[i].type == "button"
      ) {
    ...
    if (eele) {
      for (var i = 0; i < eele.setName.length; i++) {
        if (eele.setName[i] == "for") {
          ...
          eele.setValue[i]
            ? dom.setAttribute(eele.setName[i], "checked")
            : null;
  ...
  itemDel: function (e) {
    ...
    if (confArray[0] == "per_pers") {
      ...
      chrome.permissions.remove({ permissions: [thepers] }, function (removed) {
        removePer(removed);
      });
      return;
    }
    if (confArray[0] == "per_orgs") {
      ...
      chrome.permissions.remove({ origins: [theorgs] }, function (removed) {
        removePer(removed);
      });
      return;
    }
    ...
    for (
      var i = 0;
      i < (confArray.length >= 3 ? confArray.length : confArray.length);
      i++
    ) {
      confOBJ = confOBJ[confArray[i]];
    }
    ...
    if (confArray[1] == "engine" || confArray[1] == "script") {
      ...
      for (j = 0; j < OBJArray.length; j++) {
        for (var i = 0; i < OBJArray[j].length; i++) {
          for (
            var ii = 0;
            OBJArray[j][i].selects && ii < OBJArray[j][i].selects.length;
            ii++
          ) {
            if (
        ...
        for (var i = 0; i < OBJArray[j].length; i++) {
          for (
            ...
            if (OBJArray[j][i].selects[ii].type == "n_" + theType) {
              ...
              if (
                Math.abs(OBJArray[j][i].selects[ii].value) > Math.abs(delId)
              ) {
                OBJArray[j][i].selects[ii].value =
                  Math.abs(OBJArray[j][i].selects[ii].value) - 1;
              }
            }
          }
        }
  ...
  showMsgBox: function (str, type, mytime, index) {
    ...
    window.setTimeout(function () {
      OBJ.style.cssText +=
        "transition:all .4s ease-in-out;top:70px;opacity:1;z-index:" + index;
    }, 100);
    window.setTimeout(function () {
      OBJ.style.cssText +=
        "transition:all .5s ease-in-out;top:0px;opacity:0;z-index:1";
    }, mytime * 1000);
  },
  posMsgBox: function () {
    var OBJ = document.querySelector("#msgbox");
      ...
      (window.innerWidth -
        parseInt(
          window
            ...
            .width.substr(0, window.getComputedStyle(OBJ).width.length - 2),
        )) /
        2 +
      "px";
  },
    ...
    for (var i = 0; i < uitype.length; i++) {
      dom.appendChild(
        suo.domCreate2(
          "input",
          {
            ...
            setValue: [
              "checkbox",
              "init uicheckbox change-input change-ui uienable",
            ],
          },
          null,
          null,
      ...
      dom.appendChild(
        suo.domCreate2(
          ...
          null,
          null,
          suo.getI18n("ui_" + uitype[i] + "_enable"),
        ),
      );
      dom.appendChild(suo.domCreate2("br"));
      var dompart = suo.domCreate2(
        "div",
        { setName: ["className"], setValue: ["uibox"] },
        null,
        null,
        { setName: ["confobj"], setValue: [type + "|ui|" + uitype[i]] },
      );
  ...
  initMenu: function () {
    ...
    for (var i = 0; i < menuModel.main.length; i++) {
      ...
      if (
        i > 1 &&
        i <
          menuModel.main.length -
            1 /*&&config.general.fnswitch[menuModel.main[i]]*/
      ) {
  ...
  clickMenuLI: function (e) {
    ...
    document.querySelector("#top").style.cssText +=
      "background-color:" + suo.randColor();
    var ele = e.target || e;
    ...
    var setDom = document.querySelector(
      ".set-" + ele.dataset.id0 + ele.dataset.id1,
    );
    if (setDom) {
    ...
    for (var i = 0; i < suo.cons.sort.length; i++) {
      if (suo.cons.sort[i][0] == id0 && suo.cons.sort[i][1] == id1) {
        suo.cons.sortDom = Sortable.create(
          document.querySelector(".set-" + id0 + id1 + " ul.con-item"),
          {
            animation: 200,
            easing: "ease-in-out",
  ...
  clickMenuDiv: function (e) {
    ...
    for (var i = 0; i < menuULDoms.length; i++) {
      ...
      if (window.getComputedStyle(menuULDoms[i]).opacity) {
        ...
        menuULDoms[i].style.cssText +=
          "display:none;transition:all .2s ease-in-out;height:0;opacity:0;";
        window.setTimeout(function () {
  ...
  createMoreSelect: function (type, value, confOBJ) {
    ...
    if (["n_txtengine", "n_imgengine", "n_script"].contains(type)) {
      ...
      for (
        ...
        i <
        (type == "script"
          ? config.general.script[type].length
          : config.general.engine[type].length);
        i++
      ) {
      ...
      let _obj = {};
      _obj =
        actionOptions.special[confOBJ.name] &&
          ...
          for (var i = 0; i < conf.options.settings.length; i++) {
            ...
            switch (conf.options.settings[i].typeSetting) {
              ...
              case "select":
                ...
                for (
                  var ii = 0;
                  ii < conf.options.settings[i].moreSetting.length;
                  ii++
                ) {
  ...
  createMoreRadio: function (_conf) {
    ...
    var dom = suo.domCreate2(
        "div",
        { setName: ["className"], setValue: ["box_optionlist"] },
        null,
        null,
        { setName: ["confobj"], setValue: [conf.type] },
      ),
      ...
      domOption = suo.domCreate2(
        "div",
        { setName: ["className"], setValue: ["box_radio"] },
        null,
        null,
        { setName: ["confobj"], setValue: [conf.type] },
      );
  ...
  set: {
    set_11: function () {
      ...
      for (var i = 1; i < menuModel.fn.length; i++) {
        var check = suo.domCreate2(
          "input",
          {
            ...
            setValue: [
              "checkbox",
              "fnswitch change-checkbox change-fnswitch init",
            ],
          },
          "",
          "",
        ...
        var label = suo.domCreate2(
          "label",
          null,
          null,
          null,
          null,
          suo.getI18n(menuModel.fn[i]),
        );
      ...
      domOBJ.appendChild(
        suo.domCreate2(
          "div",
          { setName: ["className"], setValue: ["setdes"] },
          null,
          null,
          null,
          suo.getI18n("des_fnswitch"),
        ),
      );
    },
    set_10: function () {
      var domSet = suo.domCreate2(
        "div",
        { setName: ["className"], setValue: ["set set-10"] },
        "",
        "",
        { setName: ["conf0", "conf1"], setValue: ["general", "settings"] },
      );
  ...
  initValue: function (delayDom, delay) {
    ...
    for (var i = 0; i < doms.length; i++) {
      ...
      if (
        doms[i].tagName.toLowerCase() == "input" &&
        doms[i].type == "checkbox"
      ) {
        ...
        doms[i].id =
          ...
          confArray[1] +
          "_" +
          doms[i].dataset.confele.replace("|", "_");
  ...
  initId: function () {
    ...
    for (var i = 0; i < doms.length; i++) {
      ...
      doms[i].id =
        ...
        confArray[1] +
        "_" +
        doms[i].dataset.confele.replace(/\|/g, "_");
      doms[i].nextSibling.setAttribute("for", doms[i].id);
    }
  },
  ...
  changeUi: function (e) {
    ...
    if (
      ...
      if (
        eleType == "range" &&
        ele.nextSibling.classList.contains("uirangebox")
      ) {
      ...
      if (confArray.length == 1) {
        ...
        confOBJ[confArray[0]][confArray[1]] =
          eleType == "checkbox" ? ele.checked : ele.value;
        suo.uibox(e);
      }
    } else suo.saveConf();
  },
  ...
  changeFnswitch: function (e) {
    var ele = e.target || e;
    var domOBJ = document.querySelector(
      "#m-" + ele.dataset.confele.substr(2, ele.dataset.confele.length - 2),
    );
    if (ele.checked) {
      suo.domShow(domOBJ);
      if (!config[ele.dataset.confele.substr(2)]) {
        config[ele.dataset.confele.substr(2)] =
          defaultConf[ele.dataset.confele.substr(2)];
        suo.saveConf();
      }
      if (
        ele.dataset.confele.substr(2) == "drg" ||
        ele.dataset.confele.substr(2) == "sdrg"
      ) {
  ...
  initPer: function () {
    ...
    var theFunction = function (pers) {
      ...
      document.querySelector("#change-background").checked =
        pers.permissions.contains("background");
      if (pers.permissions.contains("browserSettings")) {
        document.querySelector("[data-confele=mouseup]").checked =
          pers.permissions.contains("browserSettings");
      }
    };
  },
    ...
    switch (type) {
      ...
      case "ksa":
        ...
        eleOBJ = {
          ...
          setValue: [
            "item item_edit item_more item_" + type,
            suo.getI18n("tip_item"),
          ],
        };
      ...
      case "ldrg":
        ...
        eleOBJ = {
          setName: ["className", "title"],
          setValue: [
            "item item_edit item_more item-" + type,
            suo.getI18n("tip_item"),
          ],
        };
        actionType = type;
    ...
    if (type == "ksa") {
      for (var i = 0; i < confOBJ.length; i++) {
        ...
        var _domCode = suo.domCreate2(
          ...
          null,
          confOBJ[i].note && confOBJ[i].note.value
  ...
  itemEditKsa: function (e, editType) {
    ...
    if (type == "edit") {
      ...
      if (["txtengine", "imgengine", "script"].contains(actionType)) {
        ...
        !editDirect
          ? (newOBJ = { name: "none" })
          : (newOBJ = { name: "none", direct: editDirect });
      }
    ...
    let btnArray = ["", suo.getI18n("btn_cancel"), suo.getI18n("btn_save")],
      btnArrayDel = [
        suo.getI18n("btn_del"),
        suo.getI18n("btn_cancel"),
        suo.getI18n("btn_save"),
      ];
    if (type == "edit") {
    ...
    let domTabListKeys = suo.domCreate2(
      "div",
      {
        setName: ["className"],
    ...
    let domTabListAction = suo.domCreate2(
      "div",
    ...
    let domTabListMore = suo.domCreate2(
      "div",
        ...
        suo.domCreate2(
          "textarea",
          {
            ...
            setValue: [
              "box-textarea",
              "textarea",
              !confOBJ.content ? "" : confOBJ.content,
            ],
          },
          "",
        ...
        domDes
          ...
          .appendChild(
            suo.domCreate2(
              ...
              null,
              null,
              "content: type or paste any code which you want.",
            ),
          );
      } else {
        domDes
          ...
          .appendChild(
            suo.domCreate2(
              ...
              null,
              null,
              "content: use %s to instead of keywords/image url. you may find some search engines from: chrome://settings/searchEngines.",
            ),
          );
      }
  ...
  initPos: function (dom) {
    ...
    window.setTimeout(function () {
      dom.style.cssText +=
        "opacity:.98;top:" + (window.innerHeight - _height) / 2 + "px;";
  ...
  itemNote: function (confOBJ, type) {
    ...
    let _span = suo.domCreate2(
        "span",
        null,
        null,
        null,
        null,
        suo.getI18n("con_notename"),
      ),
  ...
  itemDirect: function (confOBJ, actiontype, direct) {
    ...
    var OBJ = suo.domCreate2(
      "div",
      { setName: ["className"], setValue: ["box_direct"] },
      "",
      "",
      { setName: ["direct"], setValue: [direct] },
    );
    //edit icon
    var actionArray = [
      "mgesactions",
    ...
    if (direct) {
      ...
      for (var i = 0; i < direct.length; i++) {
        var dirimg = suo.domCreate2(
          ...
          "",
          "/*background-color:#000;*/-webkit-transform:rotate(+" +
            myDeg[direct[i]] +
            ")",
        );
  ...
  itemOption: function (confOBJ, actionType) {
          ...
          for (var act in arrayConfType) {
            if (actions[actionType][i][ii][arrayConfType[act]]) {
              ...
              for (
                ...
                jj < conf[arrayConfType[act]].length;
                jj++
              ) {
              ...
              for (
                var jj = 0;
                jj < actions[actionType][i][ii][arrayConfType[act]].length;
                jj++
              ) {
                _arrayModel.push(
                  actions[actionType][i][ii][arrayConfType[act]][jj],
                );
              }

              for (
                var j = 0;
                j < actions[actionType][i][ii][arrayConfType[act]].length;
                j++
              ) {
                if (conf[arrayConfType[act]]) {
                  if (
                    !_arrayConf.contains(
                      actions[actionType][i][ii][arrayConfType[act]][j],
                    )
                  ) {
              ...
              for (
                var j = 0;
                conf[arrayConfType[act]] && j < conf[arrayConfType[act]].length;
                j++
              ) {
    ...
    var checklabel = suo.domCreate2(
      "label",
      "",
      null,
      null,
      null,
      suo.getI18n("tip_actionname"),
    );
    ...
    if (conf.selects) {
      for (var i = 0; i < conf.selects.length; i++) {
        ...
        dom.appendChild(
          suo.createMoreSelect(
            conf.selects[i].type,
            conf.selects[i].value,
            conf,
          ),
        );
        dom.appendChild(suo.domCreate2("br"));
  ...
  itemDes: function (confOBJ) {
    ...
    var spacelabel = suo.domCreate2(
      "label",
      { setName: ["className"], setValue: ["boxlabel"] },
      "",
    );
    var spacelabel2 = suo.domCreate2(
      "label",
      { setName: ["className"], setValue: ["boxlabel"] },
      "",
    );
    ...
    var destext = suo.domCreate2("input", {
      ...
      setValue: [
        ...
        "box_destext",
        "text",
        confOBJ.mydes ? confOBJ.mydes.value : "",
      ],
    });
  ...
  itemSave: function (e) {
    ...
    for (var i = 0; i < fixTextarea.length; i++) {
      if (
        !fixTextarea[i].value &&
        !fixTextarea[i].classList.contains("box_notevalue")
      ) {
        console.log("blank");
        suo.showMsgBox(suo.getI18n("msg_blank"), "warning", 5, 1000);
        return;
    ...
    if (confArray[1] == "engine") {
      var _name = dom.querySelectorAll(".box_content input[type=text]")[0]
        .value;
      var _content = suo.fixURL(
        dom.querySelector(".box_content textarea").value,
      );
      confOBJ.name = _name;
      ...
      for (var i = 0; i < selectsOBJ.length; i++) {
        ...
        thisOBJ.type.indexOf("search") != -1 ||
        thisOBJ.type.indexOf("script") != -1
      ...
      //checks
      var theChecks = [];
      var checksOBJ = dom.querySelectorAll(
        ".box_more .box_check[type=checkbox]",
      );
          ...
          if (_checkList.querySelector("input[type=radio]")) {
            ...
            if (_radioList) {
              if (_radioList.querySelector("select")) {
                _confobj.valueSetting =
                  _radioList.querySelector("select").value;
              } else {
      ...
      for (var i = 0; i < radiosOBJ.length; i++) {
        var _checkRadio = radiosOBJ[i].querySelector(
          "input.box_radiooption[type=radio]:checked",
        );
        var _confobj = {};
    ...
    if (
      !["tdrg", "idrg", "ldrg", "mges", "tsdrg", "lsdrg", "isdrg"].contains(
        confArray[1],
      )
    ) {
  ...
  domShow: function (ele, time) {
    ...
    window.setTimeout(function () {
      ele.style.cssText +=
        "transition:all " + time + "s ease-in-out;opacity:1;";
    }, 10);
    window.setTimeout(function () {
  ...
  boxClose2: function (e, type) {
    ...
    var closeArray = theEle.dataset.close
      ? theEle.dataset.close.split("|")
      : [];
    domBoxBG
      ? (domBoxBG.style.cssText += "transition:all .4s ease-in-out;opacity:0;")
      : null;
  ...
  actionChange2: function (e) {
    ...
    for (var i = 0; i < actions[actionType].length; i++) {
      for (var ii = 0; ii < actions[actionType][i].length; ii++) {
        if (
          actions[actionType][i][ii].name ==
          e.target.options[e.target.selectedIndex].value
        ) {
          if (actions[actionType][i][ii].selects) {
            for (
              var j = 0;
              j < actions[actionType][i][ii].selects.length;
              j++
            ) {
              if (!theOBJ.selects) {
                theOBJ.selects = [];
          ...
          if (actions[actionType][i][ii].checks) {
            for (var j = 0; j < actions[actionType][i][ii].checks.length; j++) {
              ...
              theOBJ.checks.push({
                type: actions[actionType][i][ii].checks[
                  j
                ] /*,value:actionOptions.checks*/,
              });
            }
          }
    ...
    if (getele(ele).querySelector(".actionbox")) {
      ...
      getele(ele)
        .querySelector(".actionbox")
        .appendChild(suo.itemMore(theOBJ, actionType));
    } else if (getele(ele).querySelector(".box_option")) {
      getele(ele).querySelector(".box_option").innerHTML = "";
      getele(ele)
        .querySelector(".box_option")
        .appendChild(suo.itemOption(theOBJ, actionType));
    }
    // getele(ele).querySelector(".actionbox").appendChild(suo.itemDes(theOBJ));
      ...
      try {
        ...
        if (importedConfig.general) {
          ...
          localStorage.setItem(
            "sync",
            importedConfig.general.sync.autosync.toString(),
          );
          config = {};
  ...
  initEnd: function () {
    ...
    document.querySelector("#main").style.cssText +=
      "opacity:1;transition:all .9s ease-in-out;display:block;";
    ...
    document.querySelector("#abinfo_ver").innerText +=
    ...
    if (localStorage.getItem("showlog") == "true") {
      ...
      suo.clickMenuLI(
        document.querySelector("li[data-id0='13'][data-id1='0']"),
      );
    ...
    if (browserType == "cr") {
      if (devMode) {
        suo.cons.webstoreURL =
          "https://chrome.google.com/webstore/detail/jbfidehpoofganklkddfkcjeeaabimmb";
      } else {
        suo.cons.webstoreURL =
      ...
      suo.cons.webstoreURL =
        "https://microsoftedge.microsoft.com/addons/detail/elponhbfjjjihgeijofonnflefhcbckp";
    }
    ...
    chrome.browserSettings && chrome.browserSettings.contextMenuShowEvent
      ? chrome.browserSettings.contextMenuShowEvent
          .get({})
  ...
  initLog: function () {
    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState == 4) {
        ...
        var _summaryMore = suo.domCreate2(
          "summary",
          null,
          null,
          null,
  ...
  menuBarRemove: function () {
    ...
    document.querySelector("menu #menu_name").style.cssText +=
  ...
  menuBarCreate: function () {
    if (
      window.getComputedStyle(document.querySelector("#menu_topbox")).display ==
      "none"
    ) {
    ...
    document.body.appendChild(
      suo.domCreate2(
        "div",
        { setName: ["id"], setValue: ["menu_bg"] },
        "",
        "background-color:rgba(0,0,0,.8);",
      ),
    );
    document.querySelector("menu").style.cssText += "left:0;top:0;";
    document.querySelector("menu #menu_logo").style.cssText +=
      "margin-left:180px;";
  ...
  initSizePos: function () {
    ...
    suo.cons.sizePos.mainHeight = Math.min(
      Math.max(window.innerHeight - 300, 350),
      800,
    );
    suo.cons.sizePos.mainMinHeight = window.innerHeight - 200 < 200 ? 0 : 450;

    if (suo.cons.menuPin) {
      suo.cons.sizePos.mainPosX =
        (window.innerWidth + 260 - suo.cons.sizePos.mainWidth) / 2;
    } else {
      suo.cons.sizePos.mainPosX =
        (window.innerWidth - suo.cons.sizePos.mainWidth) / 2;
    }
    suo.cons.sizePos.btn_add_right =
      (window.innerWidth -
        Math.abs(
          window
            .getComputedStyle(mainOBJ)
            .width.substr(0, window.getComputedStyle(mainOBJ).width.length - 2),
        )) /
        2 -
      56 -
      20;
    suo.cons.sizePos.btn_add_right = suo.cons.menuPin
      ? suo.cons.sizePos.btn_add_right - 130
      : suo.cons.sizePos.btn_add_right;
  ...
  fixSizePos: function () {
    ...
    document.querySelector("#main").style.cssText +=
      "width:" +
      suo.cons.sizePos.mainWidth +
      "px;left:" +
      suo.cons.sizePos.mainPosX +
      "px;min-height:" +
      suo.cons.sizePos.mainMinHeight +
      "px;";
    window.setTimeout(function () {
      suo.cons.sizePos.btn_add_right =
        (window.innerWidth -
          Math.abs(
            window
              ...
              .width.substr(
                0,
                window.getComputedStyle(mainOBJ).width.length - 2,
              ),
          )) /
          2 -
        56 -
      ...
      document.querySelector("#btn_add")
        ? (document.querySelector("#btn_add").style.cssText +=
            "right:" +
            (suo.cons.sizePos.btn_add_right > 80
              ? suo.cons.sizePos.btn_add_right
              : 80) +
            "px;")
        : null;
    ...
    if (suo.cons.menuPin) {
      ...
      document.querySelector("#menubox").style.height =
        window.innerHeight - 64 - 80 - 40 + 75 - 40 + "px";
      //document.querySelector("#menu_bottom").style.cssText+="bottom:0px;";
    } else {
      ...
      document.querySelector("menu #menu_name").style.cssText +=
        "display:none;opacity:0;";
      document.querySelector("#menubox").style.height =
        window.innerHeight - 64 - 80 - 40 + 60 + "px";
    }
  },
  randColor: function () {
    var colorStr = "";
  ...
  itemAddBefore: function (e) {
    ...
    if (confArray[1] == "ldrg") {
      ...
      testDom.appendChild(
        suo.domCreate2("img", { setName: ["src"], setValue: ["../icon.png"] }),
      );
    }
    var addOBJ = suo.initAPPbox(
      btnArray,
      [480, 320],
      suo.getI18n("title_newaction"),
      "bg",
    );
  ...
  donateBox: {
    ...
    dom: function (items) {
      ...
      let initDom = function (itemOBJ, id) {
        ...
        var _content = suo.domCreate2(
          "div",
          { setName: ["className"], setValue: ["donate_contentlist"] },
          null,
          null,
          { setName: ["id"], setValue: [id] },
        );
        switch (itemOBJ.type) {
          case "cryptocurrency":
            ...
            for (var i = 0; i < itemOBJ.data.length; i++) {
              var _cccontent = suo.domCreate2(
                "div",
                { setName: ["className"], setValue: ["donate_cccontent"] },
                null,
                null,
                { setName: ["id"], setValue: [i] },
              );

              _cccontent.appendChild(
                suo.domCreate2(
                  "textarea",
                  {
      ...
      for (
        ...
        items.donate &&
        items.donate[0] &&
        items.donate[0].length > 0 &&
        i < items.donate[0].length;
        i++
      ) {
      ...
      if (
        items &&
        items.donate &&
        items.donate[0][0].type == "cryptocurrency"
      ) {
        console.log("cc");
        suo.donateBox.switchCcli(
          document.querySelector("#donate_content li.donate_ccli[data-id='0']"),
        );
      }
    },
    switchCcli: function (dom) {
      ...
      document
        .querySelector(
          ".donate_ccdiv .donate_cccontent[data-id='" + dom.dataset.id + "']",
        )
        .classList.add("donate_contentcurrent");
    },
    switch: function (dom) {
      let lists = document.querySelectorAll("#donate_main #donate_list li"),
        contents = document.querySelectorAll(
          "#donate_main #donate_content .donate_contentlist",
        );
      ...
      console.log(dom.dataset.id);
      document
        .querySelector(".donate_contentlist[data-id='" + dom.dataset.id + "']")
        .classList.add("donate_contentcurrent");
    },
    show: function () {
    ...
    showDonate: function () {
      ...
      document.querySelector("#donate_loading").style.cssText +=
        "display:none;";
      // domMain.style.cssText+="display:block;";
      document.querySelector("#donate_main").style.cssText += "display:block;";
      document.querySelector("#donate_btn_close").style.cssText +=
        "display:block;";
...
chrome.runtime.onMessage.addListener(function (message, sender, sendResponse) {
  switch (message.type) {
    case "confErr":
      suo.showMsgBox(
        [
          suo.getI18n("msg_conferr0"),
          message.lastErr,
          suo.getI18n("msg_conferr1"),
        ],
        "error",
        "5",
        10000,
